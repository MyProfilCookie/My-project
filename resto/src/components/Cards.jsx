...
function Cards({ item }) {
    ...
    return (
        <div>
            <div className="card w-96 md-w-70 md-mx-auto bg-white shadow-xl p-10 m-8 relative transition duration-300 ease-in-out gap-3">
                ...
                <Link to={`/recettes/${item.id}`}>
                    <figure><img src={item.image} alt="Shoes" className="w-64 rounded-full shadow-2xl hover-scale-110 transition duration-300" style={{ width: '100%', height: '100%' }} /></figure>
                </Link>
