    ...
    <div className='container mx-auto px-4 xl-px-24 max-w-screen-2xl'>
      ...
      <div className='section-container py-24 flex md-flex-col-reverse justify-between items-center gap-8'>
        ...
        <div className='md-w-half space-y-7 px-4 sd-w-full '>
          <h2 className='md-text-5xl text-4xl font-bold md-leading-snug leading-snug'> Lorem ipsum dolor sit amet, consectetur adipiscing <span className='text-red'>elit</span>.</h2>
